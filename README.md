...
🛍 **Product List** – Browse products fetched from the DummyJSON API.

🔎 **Product Search** – Instantly search and filter products.

🛒 **Cart System** – Add, remove, and manage items in the cart.

📦 **Multi-Screen Order Placement** – Step-by-step order workflow across multiple screens.

🧭 **Compass** – Built-in compass utility.

🕌 **Namaz Section** – Dedicated prayer-related functionality.

📖 **Surah Playlist** – Listen to Surah videos with a playlist interface.

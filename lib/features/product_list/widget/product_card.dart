...
class ProductCard extends StatelessWidget {
  ...
  final String rating;
  final String stock;
  final String warrentyInformation;
  ...
  const ProductCard({
    ...
    required this.stock,
    required this.warrentyInformation,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text("Warrenty: ", style: AppTextStyles.label),
                      Text(warrentyInformation, style: AppTextStyles.bodyS),
                    ],
                  ),
                ],
              ),
